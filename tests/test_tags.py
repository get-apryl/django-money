...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("{% load djmoney %}{% money_localize money off as NEW_M %}{{NEW_M}}", "PLN2.30", {"money": Money(2.3, "PLN")}),
        ("{% load djmoney %}{% money_localize money off as NEW_M %}{{NEW_M}}", "PLN0.00", {"money": Money(0, "PLN")}),
        (
        ...
        ("{% load djmoney %}{% money_localize money off %}", "PLN2.30", {"money": Money(2.3, "PLN")}),
